 ...
 */
class ANDROIDXRTRACKABLESOBJECT_API IAndroidXRTrackablesObjectModule : public IModuleInterface
{
public:
    /**
     ...
     */
    static inline IAndroidXRTrackablesObjectModule& Get()
    {
        return FModuleManager::LoadModuleChecked<IAndroidXRTrackablesObjectModule>("AndroidXRTrackablesObject");
    }
    ...
    {
        return FModuleManager::Get().IsModuleLoaded("AndroidXRTrackablesObject");
    }
     ...
     */
    virtual bool CreateObjectTrackableTracker(const TSet<EAndroidXRTrackablesObjectLabel>& ActiveLabels,
        FAndroidXRTrackableTracker& TrackableTracker) = 0;

    /**
     * Gets an FAndroidXRTrackableObject from an FAndroidXRTrackable.
     * @param[in] TrackableTracker Previously created object tracker.
     * @param[out] Trackable Previously obtained trackable.
     * @param[out] TrackableObject Trackable object.
     * @return True if the underlying API call was successful.
     */
    virtual bool GetTrackableObject(const FAndroidXRTrackableTracker& TrackableTracker,
        const FAndroidXRTrackable& Trackable,
        FAndroidXRTrackableObject& TrackableObject) = 0;
};
