 ...
 */
class ANDROIDXRRECOMMENDEDRESOLUTION_API IAndroidXRRecommendedResolutionModule : public IModuleInterface
{
public:
    /**
     ...
     */
    static inline IAndroidXRRecommendedResolutionModule& Get()
    {
        return FModuleManager::LoadModuleChecked<IAndroidXRRecommendedResolutionModule>(RecommendedResolutionModuleName);
    }
    ...
    {
        return FModuleManager::Get().IsModuleLoaded(RecommendedResolutionModuleName);
    }
    ...
    */
    virtual UAndroidXRRecommendedResolutionEventProxy* GetEventProxy() = 0;

private:
   inline static FName RecommendedResolutionModuleName = "AndroidXRRecommendedResolution";
