 ...
 */
class HANDINTERACTIONINPUTDEVICE_API IHandInteractionInputDeviceModule : public IInputDeviceModule
{
public:
    /**
     ...
     */
    static inline IHandInteractionInputDeviceModule& Get()
    {
        return FModuleManager::LoadModuleChecked<IHandInteractionInputDeviceModule>("HandInteractionInputDevice");
    }
    ...
    {
        return FModuleManager::Get().IsModuleLoaded("HandInteractionInputDevice");
    }
};
