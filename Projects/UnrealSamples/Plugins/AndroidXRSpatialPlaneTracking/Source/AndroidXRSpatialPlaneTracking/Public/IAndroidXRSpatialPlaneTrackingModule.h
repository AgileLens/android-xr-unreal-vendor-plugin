...
class ANDROIDXRSPATIALPLANETRACKING_API IAndroidXRSpatialPlaneTrackingModule : public TIAndroidXRSpatialCapabilityModule<UAndroidXRSpatialPlaneEntity>
{
public:
    /**
    ...
    */
    static inline IAndroidXRSpatialPlaneTrackingModule& Get()
    {
        return FModuleManager::LoadModuleChecked<IAndroidXRSpatialPlaneTrackingModule>("AndroidXRSpatialPlaneTracking");
    }
    ...
    {
        return FModuleManager::Get().IsModuleLoaded("AndroidXRSpatialPlaneTracking");
    }
};
